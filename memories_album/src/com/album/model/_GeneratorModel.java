...
public class _GeneratorModel
{
	...
	public static DataSource getDataSource()
	{
		...
		DruidPlugin druidPlugin = new DruidPlugin(p.get("jdbcUrl"),
	...
	{
		// base model 所使用的包名
		String baseModelPackageName = "com.album.model.base";
		// base model 文件保存路径
		String baseModelOutputDir = PathKit.getWebRootPath() + "/src/com/album/model/base";
		// model 所使用的包名 (MappingKit 默认使用的包名)
		String modelPackageName = "com.album.model";
